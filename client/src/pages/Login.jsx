...
import { LogIn, ArrowLeft, Eye, EyeOff, ChevronRight } from 'lucide-react';
import loginBg from '../assets/register-bg-2.jpg';
      ...
      <div style={{ 
        ...
        <div style={{ width: '100%', maxWidth: '380px' }}>
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <p style={{ fontSize: '0.85rem', color: 'rgba(255, 255, 255, 0.5)', marginBottom: '8px' }}>Welcome back!</p>
            <h1 style={{ fontSize: '2.5rem', fontWeight: '600', letterSpacing: '-0.03em', fontFamily: 'var(--font-heading)' }}>Sign into InitPhase</h1>
          </div>
